...
#include <memory>
#include "../../Magazyn/wypozyczalnia.h"
...
QT_MOC_LITERAL(3, 37, 23) // "on_pushButton_2_clicked"
    ...
    "Wypozyczalnia\0on_pushButton_clicked\0"
...
void Wypozyczalnia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Wypozyczalnia *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Wypozyczalnia::staticMetaObject = { {
    ...
    qt_meta_stringdata_Wypozyczalnia.data,
    qt_meta_data_Wypozyczalnia,
    qt_static_metacall,
    nullptr,
    nullptr
} };
