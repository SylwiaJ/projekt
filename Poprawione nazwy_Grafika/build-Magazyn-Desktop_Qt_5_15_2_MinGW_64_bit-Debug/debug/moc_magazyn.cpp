...
QT_MOC_LITERAL(4, 55, 23) // "on_pushButton_3_clicked"
    ...
    "Magazyn\0on_pushButton_clicked\0\0"
...
void Magazyn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Magazyn *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Magazyn::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Magazyn.data,
    qt_meta_data_Magazyn,
    qt_static_metacall,
    nullptr,
    nullptr
} };
